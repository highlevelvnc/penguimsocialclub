...
export function PosHeader({
  ...
  return (
    <header className="relative flex h-12 flex-shrink-0 items-center justify-between bg-zinc-900/90 px-4 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-2">
        {/* Staff */}
        <div className="flex items-center gap-2 rounded-full bg-zinc-800/60 px-2.5 py-1 border border-zinc-700/30">
        ...
        <button
          type="button"
          onClick={handleLock}
          className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs text-zinc-500 transition-all hover:bg-zinc-800 hover:text-zinc-300"
        >
